        ...
        --> */}
            ...
            <div className="relative">
              ...
              <button
                ...
                type="button"
                className="group rounded-md text-blueGray-800 inline-flex items-center text-base font-medium hover:text-blueGray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500"
              >
                <span>More</span>
                {/* <!--
            Heroicon name: chevron-down
          ...
          --> */}
                <svg
                  className="ml-2 h-5 w-5 text-coolGray-600 group-hover:text-blueGray-600"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                  aria-hidden="true"
                ...
                <div className="absolute left-1/2 z-10 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md sm:px-0">
                  <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                    ...
                    <div className="px-5 py-5 bg-blueGray-50 sm:px-8 sm:py-8">
                      <div>
                        <h3 className="text-sm tracking-wide font-medium text-blueGray-800 uppercase">
                          Recent Posts
                        </h3>
                        <ul className="mt-4 space-y-4">
                          <li className="text-base truncate">
                            <a
                              href="/"
                              className="font-medium text-blueGray-900 hover:text-blueGray-700"
                            >

...
const Footer = () => {
  const [showFullYear, setShowFullYear] = React.useState()

  React.useEffect(() => {
    const date = new Date()
    const justYear = date.getFullYear()
    setShowFullYear(justYear)
  }, [])
  ...
  return (
    ...
    <footer className="bg-blueGray-800">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        ...
        {/* THIS IS THE NEWSLETTER SECTION ----- NOT READY YET FOR THIS */}
        {/* <div className="border-t border-gray-700 pt-8 space-y-4 lg:space-y-0 lg:flex lg:items-center lg:justify-between xl:mt-0">
          ...
          <form className="sm:flex sm:max-w-md">
            ...
            <div className="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
              <button
                type="submit"
                className="w-full bg-yellow-600 border border-transparent rounded-md py-2 px-4 flex items-center justify-center text-base font-medium text-white hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-yellow-500"
              >
                Subscribe
              </button>
            </div>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
            &copy; {showFullYear} Meerkat IT Solutions, LLC. All rights
            reserved.
          </p>
        </div>
      </div>
